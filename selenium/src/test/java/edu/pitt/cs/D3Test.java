...
public class D3Test {
  ...
  public void tEST1LINKS() {
    ...
    // 3 | storeAttribute | //a[contains(text(),'Reset')]@href | link
    {
  ...
  public void tEST3CATALOG() {
    ...
    // 4 | storeAttribute | //li[2]/img@src | imgSource
    {
      WebElement element = driver.findElement(By.xpath("//li[2]/img"));
      String attribute = element.getAttribute("src");
      vars.put("imgSource", attribute);
    }
    // 5 | assert | imgSource | /images/cat2.jpg
    assertEquals(vars.get("imgSource").toString(), "http://localhost:8080/images/cat2.jpg");
  }
  @Test
  public void tEST4LISTING() {
    ...
    // 3 | click | linkText=Catalog | 
    driver.findElement(By.linkText("Catalog")).click();
    // 4 | assertText | xpath=//div[@id='listing']/ul/li[3] | ID 3. Mistoffelees
